<?php
  ...
  $ruta_arreglo = explode('/', $archivoTmp);
  $nombre_archivo = end($ruta_arreglo);
  echo ("<BR><span class='info'> Por favor guarde el archivo y verifique que los datos de combinacion  esten correctos <br>");
  echo "<a href='$ruta_raiz/descargar_archivo_masiva.php?ruta_archivo=$archivoTmp&nombre_archivo=$nombre_archivo'><span class='$radFileClass'>Guardar Archivo</span></a>";
