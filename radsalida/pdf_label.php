...
//                -size    : defaut char size (can be changed by calling Set_Char_Size(xx);
...
class PDF_Label extends FPDF {
    ...
    var $_Y_Space         = 1;                // Vertical space between 2 labels
    ...
    var $_Avery_Labels = array (
        ...
        '8600'=>array('name'=>'8600',    'paper-size'=>'letter',    'metric'=>'mm',    'marginLeft'=>7.1,         'marginTop'=>19,         'NX'=>1,     'NY'=>4,     'SpaceX'=>9.5,         'SpaceY'=>3.1,     'width'=>66.6,         'height'=>25.4,        'font-size'=>8),
    ...
    function _Get_Height_Chars($pt) {
        ...
        $_Table_Hauteur_Chars = array(6=>2, 7=>2.5, 8=>3, 9=>4, 10=>7, 11=>6, 12=>7, 13=>8, 14=>9, 15=>10);
    ...
    function Set_Char_Size($pt) {
        if ($pt > 3) {
			...
			//$this->AddFont('Courier','','courier.php');
			$this->SetFont('Courier','',10); 
            //$this->SetFont('Courier-New','',$pt); 
        }
    }
