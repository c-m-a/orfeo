...
<html>
  <head>
    ...
    <base href="{$URL_APP}">
    <link href="http://www.panopta.com/static/bootstrap-wizard-plugin/demo/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="http://www.panopta.com/static/bootstrap-wizard-plugin/src/bootstrap-wizard.css" rel="stylesheet" />
	  <link href="http://www.panopta.com/static/bootstrap-wizard-plugin/demo/chosen/chosen.css" rel="stylesheet" />
    <script type="text/css">
      ...
      .wizard-modal .chzn-container .chzn-result {
        max-height: 150px;
      }
  ...
  <body>
    <div class="wizard" id="wizard-demo">
      <h1>Instalador {$NOMBRE_APP}</h1>
      <h2>Version {$VERSION_APP}</h2>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
		<script src="http://www.panopta.com/static/bootstrap-wizard-plugin/demo/chosen/chosen.jquery.js"></script>
    <script src="http://www.panopta.com/static/bootstrap-wizard-plugin/demo/bootstrap/js/bootstrap.min.js"></script>
    <script src="http://www.panopta.com/static/bootstrap-wizard-plugin/src/bootstrap-wizard.js"></script>
