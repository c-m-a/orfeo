              ...
              <td valign="top">
                ...
                {/foreach}
                  ...
                  <tr valign="middle">
                    ...
                    <td width="125">
                      <a onclick="cambioMenu({$ID_CUERPO_TX});verPersonales({$ID_CUERPO_TX});" href='#marcaPersonales";' class="menu_princ"  alt="Despliegue de Carpetas Personales" title="Despliegue de Carpetas Personales" name="marcaPersonales">
                      PERSONALES
                      </a>
                    </td>
                  </tr>
