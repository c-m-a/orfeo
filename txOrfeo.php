...
<?
	if($_SESSION["vbAllDependencias"]!=1){
	  echo "envioTx();";
	}
?>
}
...
<td width="58" valign="bottom">
	...
	<a href="#" onmouseout="MM_swapImgRestore()" onclick="seleccionBarra = 14;vistoBueno();" onmouseover="MM_swapImage('Image12','','<?=$ruta_raiz?>/imagenes/internas/overVobo.gif',1)">
	<img src="<?=$ruta_raiz?>/imagenes/internas/vobo.gif" name="Image12" width="55"  border="0"></a></td>
    <?
    		}
	}
	?>
