...
?>
  <tr class='tpar'>
    ...
    <td class="listado2"><center><?=$numero_dias?> d&iacute;as</center></td>
    <td class="listado2"><?=$trans->getDescripcion()?></td>
    <td class="listado2"><?=$objUs->get_usua_nomb()?></td>
		<td class="listado2"><?=utf8_decode($rs->fields["HIST_OBSE"])?></td>
  </tr>
<?php
  ...
  foreach ($registros as $registro) {
    if ($krd == 'ADMIN3') {
      ...
      echo '<td class="listado2" ><center>'. $nro_dias .' d&iacute;as</center></td>' . "\n";
