...
/* Se establece la fuente que se utilizara para el texto. */
	...
	{	fputs ($fp,"plantilla=$this->arcPlantilla"."\n");
        ...
        $dato_r = str_replace('&', 'Y', $dato_r);
        $dato_r = str_replace('ñ', 'n', $dato_r);
        $dato_r = str_replace('Ñ', 'N', $dato_r);
        $dato_r = str_replace('º', 'o', $dato_r);
        $dato_r = str_replace('°', 'o', $dato_r);
				...
				if($campos_d=="*NOMBRE*" or $campos_d=="*NOM_E*") $nombre_us1 =$dato_r;
