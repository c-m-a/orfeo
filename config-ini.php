<?php
  ...
  if (!defined('URL_ENTIDAD')) {
    define ('URL_ENTIDAD', 'http://www.nombre_de_la_entidad.com');
    define ('URL_ENTIDAD_STICKER', 'http://www.nombre_de_la_entidad.com');
    define ('URL_ENTIDAD_CORTO', 'http://www.nombre_corto_entidad.com');
  ...
  if (!defined('ADM_PHP_MAILER')) {
    define ('ADM_PHP_MAILER',   'usuario@dominio.com');
    define ('USER_PHP_MAILER',  'usuario@dominio.com');
    define ('PASS_PHP_MAILER',  'contrasena');
    define ('HOST_PHP_MAILER',  'smtp.dominio.com');
    define ('PORT_PHP_MAILER',  587);
    define ('ASUNTO_PHP_MAILER', 'Respuesta de su radicado en NOMBRE ENTIDAD');
    define ('ASUNTO_ENTIDAD',   ' NOMBRE DE LA ENTIDAD');
  ...
  $servProcDocs   = "127.0.0.1:8080";
  
  $entidad        = 'SES';
  //Variable usada generalmente para los titulos en informes.
  $entidad_largo  = 'NOMBRE DE LA ENTIDAD';
  
  $entidad_tel    = 'TELEFONO';            // Telefono o PBX de la empresa.
  $entidad_dir    = 'direccion';   // Direccion de la Empresa.
  $entidad_depsal = 999;
  ...
  if(!defined('LOGO_ENTIDAD')) {
    ...
    define ('DIRECCION',    'direccion de la entidad');
    define ('PBX',          'telefonos entidad');
    define ('LINEA_GRATIS', '01-800-00 00 000');
  ...
  $servidor_mail= 'imap.sevidor_correo.com';
  ...
  */ 
  ...
  if (!defined('SERVIDOR_FAX')) {
    // Direccion IP o nombre del servidor de Fax
    define('SERVIDOR_FAX',      'nombre servidor');
    
    // Usuario de conexion de FAX
    define('USUARIO_ADMIN_FAX', 'usuario_fax');
    
    // Password usuario de fax
    define('PASSWORD_FAX',      'password');
    
    // Esto Imagen de para el modulo de fax
    define('IMAGEN_FAX',        BODEGA_TMP . 'fax.jpg');
  }

  // Ni idea para que funciona esta variable
  $n_dias_pass = 800;                       //maqr marzo 2007
