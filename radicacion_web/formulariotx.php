...
*/
$ins_his="insert into hist_eventos (depe_codi,hist_fech,usua_codi,radi_nume_radi,hist_obse,usua_codi_dest,usua_doc,sgd_ttr_codigo,hist_doc_dest,depe_codi_dest) 
values($dependenciaRad,to_date('".$fechaval."','dd/mm/yyyy hh24:mi:ss'),6,".$_SESSION['numeroRadicado'].",'RADICACION PAGINA WEB',".$_SESSION['usuaRecibeWeb'].",'22222222',2,'".$_SESSION['documento_destino']."',".$_SESSION['depeRadicaFormularioWeb'].");";
