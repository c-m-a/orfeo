...
$_SESSION['nit']=trim(str_replace(".","",$_GET['nit']));
if(!$_GET['nit']) $_SESSION['nit'] = "0";
if(!$_GET['nit']  && $nit) $_SESSION['nit']=$nit;
...
$_SESSION['documento_destino']=trim($_GET['documento_destino']);
...
values(".$num_dir.",1,0,".$num_ciu.",".$_SESSION['numeroRadicado'].",0,".$_SESSION['muni'].",".$_SESSION['depto'].",'".$_SESSION['direccion_remitente']."','".$_SESSION['telefono_remitente']."',0,'".strtoupper($_SESSION['nombre_remitente'])." ".strtoupper($_SESSION['apellidos_remitente'])."','".strtoupper($_SESSION['sigla'])."',3,'".$_SESSION['nit']."');";
...
,'".$_SESSION['cedula']."'
,'".strtoupper($_SESSION['nombre_remitente'])."'
,'".strtoupper($_SESSION['apellidos_remitente'])."'
,'COLOMBIA'
,".$_SESSION['muni']."
,0,".$_SESSION['depto']."
,'".strtoupper($_SESSION['direccion_remitente'])."'
,".$_SESSION['telefono_remitente'].",1
,'1 FOLIO', ";
if($_SESSION['radicado']!=NULL)
...
$iSql = "select * from bodega_empresas where nit_de_la_empresa like '$nit'";
// $iSql;
if($rsE = $db->conn->Execute($iSql)){
 $_SESSION['sigla']=$rsE->fields['SIGLA_DE_LA_EMPRESA'];
 $_SESSION['espCodigo']=$rsE->fields['IDENTIFICADOR_EMPRESA'];
}


if(!$_SESSION['espCodigo']) $_SESSION['espCodigo'] = "0";
...
values (".$_SESSION['numeroRadicado'].", to_date('".$fechaval."','dd/mm/yyyy hh24:mi:ss'),".$_SESSION['tipo'].",4,".$_SESSION['espCodigo'].",
...
$ins_rad.="'/$anoRad/$depeRadicaFormularioWeb/".$_SESSION['numeroRadicado']."".".pdf'
  ...
  ,".$_SESSION['depeRadicaFormularioWeb']."
  ,'".strtoupper($_SESSION['asunto'])."'
  ,".$_SESSION['dependencia'].",6,5,1,0,0,1,0);";
//echo "<hr>".$ins_rad;
...
*/
$ins_his="insert into hist_eventos (depe_codi,hist_fech,usua_codi,radi_nume_radi,hist_obse,usua_codi_dest,usua_doc,sgd_ttr_codigo,hist_doc_dest,depe_codi_dest) 
values($dependenciaRad,to_date('".$fechaval."','dd/mm/yyyy hh24:mi:ss'),6,".$_SESSION['numeroRadicado'].",'RADICACION PAGINA WEB',".$_SESSION['usuario'].",'22222222',2,'".$_SESSION['documento_destino']."',".$_SESSION['dependencia'].");";
...
-->
  <tr>
      <td align="center">
  Para verificar la autenticidad de sus datos hemos enviado un correo electr&oacute;nico a : <strong><?= $_SESSION['email'] ?></strong>. Para continuar con la solicitud de su queja ingrese a su correo y siga las instrucciones. Si lo desea puede cerrar esta ventana. 
          <br />
          <br />
          <h3>
             Si no confirma su queja desde su correo electronico el tramite no sera tramitado.
          </h3>
            <br />
          <br />
        </td>
