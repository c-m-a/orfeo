	...
	switch(opt.value)
	{
		case "pys":
			...
			if(window.confirm(mensaje))	{
				urlSancRegist = "bdcompleme/pazysalvoscta.php?krd=<?=$krd?>&bd=PazySalvoscta&nit=<?=$cc_documento_us3?>&verrad=<?=$verrad?>&id=<?=$documento?>&ano="+document.form_bdcomple.Ano.value;//+"&";
