...
$sql="select b.USUA_NOMB USUARIO,a.RA_ASUN as asunto,d.ANEX_CREADOR ,
	   RADI_NUME_RADI as NO_RADICADO,d.RADI_NUME_SALIDA,a.RADI_FECH_RADI,d.SGD_FECH_IMPRES,d.ANEX_ESTADO
from radicado a 
...
from radicado a 
inner join  USUARIO b on  (b.usua_CODI=a.RADI_USUA_ACTU and b.DEPE_CODI=a.RADI_DEPE_ACTU)
where TO_CHAR(a.radi_fech_radi, 'yyyy/mm/dd') BETWEEN '$CFechaIni' AND '$CFechaIni' 
