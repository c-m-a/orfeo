<?php
  ...
  if ($sololect)
    ...
    $auxsololect = "N";
  $isql = "select max(anex_numero)numero from anexos " . "where anex_radi_nume=$radi";
  ...
  if ($bien) {
    ...
    $isql = "insert into anexos " . "(anex_radi_nume,anex_codigo,anex_tipo,anex_tamano,anex_solo_lect,anex_creador,anex_desc,anex_numero,anex_nomb_archivo,anex_borrado) " . "values ($radi,$codigo,$tipo,null,'$auxsololect','$usua','$descr',$auxnumero,'$archivoconversion','N') ";
