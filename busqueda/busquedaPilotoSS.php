...
if($verImg==true) {
  $linkDocto = "<a class='$clasevinc' href='../bodega/$fldRADI_PATH' target='Imagen$iii'>";
  $linkInfGeneral = "<a class='$clasevinc' href='../verradicado.php?verrad=$fldRADI_NUME_RADI&".session_name()."=".session_id()."&carpeta=8&nomcarpeta=Busquedas&tipo_carp=0'>";
}else{ 
  $linkDocto = "";
