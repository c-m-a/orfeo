...
?>
      <td valign="bottom">
        <a href= "#" title="Asignar TRD" src="<?=$ruta_raiz?>/imagenes/internas/masTRDO.gif" onClick="masivaTRD();">
          <img name="ejemplo1" src="<?=$ruta_raiz?>/imagenes/internas/masTRD.gif" alt="Asignar Trd masiva" border="0">
        </a>
      </td>
    </tr>
	</table>
