      ...
      switch ($codTx) {
        ...
        case 13:
          {	
            ...
            $es_reasignar       = $codTx == 9;
            $es_usuario_normal  = $codusuario != 1;
            $permiso_tipificar  = $usuaPermTipifica != 3;
            $usuario_permitido  = $es_reasignar && $es_usuario_normal && $permiso_tipificar;
            $tipo_transferencia = $codTx == 16 or $codTx == 13;
            $no_son_dependencias = $dependencia !=370 or $dependencia !=371;

            $primera_parte = $usuario_permitido and ($no_son_dependencias);
            
            $cumple_condicion = ($primera_parte) or $tipo_de_transferencia;
