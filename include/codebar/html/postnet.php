...
$table->setText($n+2,1,'<ul style="margin: 0px; padding-left: 25px;"><li>Used to encode enveloppe in USA.</li><li>You can provide<br />5 digits (ZIP Code)<br />9 digits (ZIP+4 code)<br /> 11 digits (ZIP+4 code+2digits)<br />(Those 2 digits are taken from your address. If your address is 6453, the code will be 53.)</li></ul>');
$table->draw();
